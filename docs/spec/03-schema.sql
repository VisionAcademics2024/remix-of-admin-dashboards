...
-- =============================================================================
-- 13. LEADS & TRIALS  — the pre-student pipeline (01-domain-model.md)
--
-- Everything upstream of guardian -> student. Added after the fact by migration
-- 20260826120000_leads_trials.sql; kept here so the spec stays runnable and
-- complete. Facts only; the pipeline board reads v_leads.
-- =============================================================================
...
create table leads (
  ...
  student_name           text        not null,   -- the child; no record exists yet
  year_level             text,
  subject_interest       text,
  program_interest_id    uuid        references programs(id) on delete set null,
  guardian_name          text        not null,   -- the enquiring parent
  guardian_email         text,
